...
- [Dolphin](https://fr.dolphin-emu.org/) - Gamecube & Wii emulator ([Source Code](https://github.com/dolphin-emu/dolphin))
- [DeSmuMe](https://desmume.org/) - Nintendo DS emulator
- [Azahar](https://azahar-emu.org/) - 3DS emulator ([Source Code](https://github.com/azahar-emu/azahar))
- [mGBA](https://mgba.io) - Game Boy Advance emulator ([Source Code](https://github.com/mgba-emu/mgba))
- [Cemu](https://cemu.info/)* - Wii U emulator ([Source Code](https://github.com/cemu-project/Cemu))
- [Citron](https://citron-emu.org/) - Nintendo Switch emulator ([Source Code](https://git.citron-emu.org/citron/emulator))

**Recommended software to download games (best for Cemu). [Wii U USB Helper](https://github.com/FailedShack/USBHelperInstaller)*
...
- ~~[Plex](https://www.plex.tv/) - Multimedia streaming service ([Source Code](https://github.com/plexinc))~~ - Use Jellyfin instead
...
- [MusicPresence](https://musicpresence.app/) - Discord Rich Presence for media players ([Source Code](https://github.com/ungive/discord-music-presence))
...
- [HandBrake](https://handbrake.fr/) - Open-Source video converter software ([Source Code](https://github.com/HandBrake/HandBrake))
...
- [WinMerge](https://winmerge.org/) - Open-Source software to compare files/folders ([Source Code](https://github.com/winmerge/winmerge))
- [AutoHotkey](https://www.autohotkey.com/) - Open-Source scripting software
- [Windhawk](https://windhawk.net/) - Windows customization program ([Source Code](https://github.com/ramensoftware/windhawk))
...
- [Fan Control](https://getfancontrol.com/) - Fan control software ([Source Code](https://github.com/Rem0o/FanControl.Releases))
...
- [OBS Studio](https://obsproject.com) - Free & Open-Source video recording and live streaming software ([Source Code](https://github.com/obsproject/obs-studio))
