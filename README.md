...
- [RPCS3](https://github.com/RPCS3/rpcs3) Playstation 3 emulator
- [ShadPS4](https://github.com/shadps4-emu/shadps4) Playstation 4 emulator

### Nintendo
- [Project64](https://github.com/project64/project64) Nintendo 64 emulator
- [Dolphin](https://github.com/dolphin-emu/dolphin) Gamecube & Wii emulator
- [DeSmuMe](https://desmume.org/) Nintendo DS emulator
- [Azahar](https://github.com/azahar-emu/azahar) 3DS emulator
- [mGBA](https://github.com/mgba-emu/mgba) Game Boy Advance emulator
- [Cemu](https://github.com/cemu-project/Cemu)* Wii U emulator
- [Citron](https://git.citron-emu.org/citron/emulator) Nintendo Switch emulator
...
- [Microsoft Activation Script (MAS)](https://github.com/massgravel/Microsoft-Activation-Scripts) Open-source Windows and Office activator
